...
import { createBasketActor } from '../../../../packages/components/basket/machine/basketMachine.js';
...
export async function mountBasketPlayground(root) {
  ...
  const [rawTemplate, seed] = await Promise.all([
    fetch('/packages/components/basket/ui/BasketStandalone.html').then((r) => r.text()),
