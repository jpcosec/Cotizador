...
import { createBasketDayActor } from '../../../../packages/components/basket-day/machine/basketDayMachine.js';
import { basketRuntimeHtml } from '../../../../packages/components/item/ui/playgroundItemSections.js';
...
export async function mountBasketDayPlayground(root) {
  ...
  const [rawTemplate, seed] = await Promise.all([
    fetch('/packages/components/basket-day/ui/BasketDayStandalone.html').then((r) => r.text()),
