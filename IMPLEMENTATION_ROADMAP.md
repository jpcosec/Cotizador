...
**Reference Documents**:
- `datamodel_v2_pricing_engine.mermaid` - ER diagram (authoritative)
- `SF_Lodge_v2_DataModel_Plan.md` - Detailed specification
...
All design questions are answered in:
- `datamodel_v2_pricing_engine.mermaid` (visual)
- `SF_Lodge_v2_DataModel_Plan.md` (detailed)
