...
import { createCategoryActor } from '../../../src/components/category/machine/categoryMachine.js';
...
export async function mountCategoryPlayground(root) {
  ...
  const [rawTemplate, seed] = await Promise.all([
    fetch('/src/components/category/ui/CategoryStandalone.html').then((r) => r.text()),
