...
import { createDatabaseActor, BROWSER_TABLES } from '../../../src/database/src/machine/databaseMachine.js';
import { DATA_SCHEMA } from '../../../src/database/src/Config_Schema.js';
import { getPrimaryKeyForTable } from '../../../src/database/src/playgroundAdapter.js';
...
export async function mountDatabasePlayground(root) {
  ...
  const templatePath = '/playground/playground/database/DatabasePlayground.html';
