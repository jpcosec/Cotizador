var QuotationEngine = (function (exports) {
  ...
  class ContainerBase extends ContainerMixin(class {}) {
    constructor() {
      super();
   ...
   */
  class Category extends ContainerBase {
   ...
   */
  class Kit extends ContainerBase {
   ...
   */
  class Catalog extends ContainerBase {
   ...
   * Price aggregation flow: Item → DayCategory → Basket
   */
  class DayCategory extends ContainerBase {
   ...
   */
  class Basket extends ContainerBase {
    /**
  ...
  const basketActions = {
    ...
    addItem: assign(({ context, event }) => {
      ...
      if (context.basket) {
        context.basket.add(itemId, overrides);
