...
| Artifact | Location |
|----------|----------|
| Clean Orchestrator | `apps/gas/Quotation_App_Source.html` |
| Global Theme | `packages/components/common/styles/theme-quotation.css` |

## Phase 01: CSS Cleanup
- [ ] Move all `<style>` content from `apps/gas/Quotation_App_Source.html` to `packages/components/common/styles/theme-quotation.css`.
- [ ] Link the CSS in the main GAS index or include it as a separate template.

## Phase 02: Template Refactor
- [ ] Rewrite `apps/gas/Quotation_App_Source.html` to be < 100 lines.
