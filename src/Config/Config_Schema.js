...
export const DATA_SCHEMA = {
  ...
  REGLAS_NEGOCIO: {
    ...
    columns: [
      ...
      { name: "Tipo_Accion", type: "ENUM", options: ["SET_VALUE", "MULTIPLY", "ADD_FIXED", "ADD_ITEM", "INVALIDATE_BASKET", "WARNING", "ERROR", "SET_TAX"], desc: "Acción ejecutable" },
  ...
  AJUSTES_COTIZACION: {
    ...
    columns: [
      ...
      { name: "Tipo_Ajuste", type: "ENUM", options: ["OVERRIDE_PRECIO", "DESCUENTO_LINEA", "DESCUENTO_GLOBAL", "RECARGO"], desc: "Tipo de intervención" },
